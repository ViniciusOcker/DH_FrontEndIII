import { NewGamesCardHorizontalLista } from "../../components/NewGamesCardHorizontalLista"

export function BatatalhaGames() {
    const newGames = [
        {
            id: 0,
            name: 'Hollow Knight',
    ...
    return(<>
        <NewGamesCardHorizontalLista listaNewGames={newGames} />
    </>)
}